...
API: Exchange Rate API (exchangerate-api / frankfurter / openexchangerates)
...
User selects base currency and target currency

Enters the amount

App fetches live exchange rates from API
...
🌐 Country flags with currency selector
